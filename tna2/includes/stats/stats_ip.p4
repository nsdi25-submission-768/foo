control c_stats_ip(inout header_t hdr, inout ingress_metadata_t ig_md) {
	...
	action rshift_cov_0() {
		hdr.foo.ip_cov = ig_md.stats_ip.sum_res_prod;
	}

	action rshift_cov_1() {
		hdr.foo.ip_cov = ig_md.stats_ip.sum_res_prod >> 1;
	}

	action rshift_cov_2() {
		hdr.foo.ip_cov = ig_md.stats_ip.sum_res_prod >> 2;
	}

	action rshift_cov_3() {
		hdr.foo.ip_cov = ig_md.stats_ip.sum_res_prod >> 3;
	}

	action rshift_cov_4() {
		hdr.foo.ip_cov = ig_md.stats_ip.sum_res_prod >> 4;
	}

	action rshift_cov_5() {
		hdr.foo.ip_cov = ig_md.stats_ip.sum_res_prod >> 5;
	}

	action rshift_cov_6() {
		hdr.foo.ip_cov = ig_md.stats_ip.sum_res_prod >> 6;
	}

	action rshift_cov_7() {
		hdr.foo.ip_cov = ig_md.stats_ip.sum_res_prod >> 7;
	}

	action rshift_cov_8() {
		hdr.foo.ip_cov = ig_md.stats_ip.sum_res_prod >> 8;
	}

	action rshift_cov_9() {
		hdr.foo.ip_cov = ig_md.stats_ip.sum_res_prod >> 9;
	}

	action rshift_cov_10() {
		hdr.foo.ip_cov = ig_md.stats_ip.sum_res_prod >> 10;
	}

	action rshift_cov_11() {
		hdr.foo.ip_cov = ig_md.stats_ip.sum_res_prod >> 11;
	}

	action rshift_cov_12() {
		hdr.foo.ip_cov = ig_md.stats_ip.sum_res_prod >> 12;
	}

	action rshift_cov_13() {
		hdr.foo.ip_cov = ig_md.stats_ip.sum_res_prod >> 13;
	}

	action rshift_cov_14() {
		hdr.foo.ip_cov = ig_md.stats_ip.sum_res_prod >> 14;
	}

	action rshift_cov_15() {
		hdr.foo.ip_cov = ig_md.stats_ip.sum_res_prod >> 15;
	}

	action rshift_cov_16() {
		hdr.foo.ip_cov = ig_md.stats_ip.sum_res_prod >> 16;
	}

	action rshift_cov_17() {
		hdr.foo.ip_cov = ig_md.stats_ip.sum_res_prod >> 17;
	}

	action rshift_cov_18() {
		hdr.foo.ip_cov = ig_md.stats_ip.sum_res_prod >> 18;
	}

	action rshift_cov_19() {
		hdr.foo.ip_cov = ig_md.stats_ip.sum_res_prod >> 19;
	}

	action rshift_cov_20() {
		hdr.foo.ip_cov = ig_md.stats_ip.sum_res_prod >> 20;
	}
	...
	action rshift_pcc_0() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov;
	}

	action rshift_pcc_1() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 1;
	}

	action rshift_pcc_2() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 2;
	}

	action rshift_pcc_3() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 3;
	}

	action rshift_pcc_4() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 4;
	}

	action rshift_pcc_5() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 5;
	}

	action rshift_pcc_6() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 6;
	}

	action rshift_pcc_7() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 7;
	}

	action rshift_pcc_8() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 8;
	}

	action rshift_pcc_9() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 9;
	}

	action rshift_pcc_10() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 10;
	}

	action rshift_pcc_11() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 11;
	}

	action rshift_pcc_12() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 12;
	}

	action rshift_pcc_13() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 13;
	}

	action rshift_pcc_14() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 14;
	}

	action rshift_pcc_15() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 15;
	}

	action rshift_pcc_16() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 16;
	}

	action rshift_pcc_17() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 17;
	}

	action rshift_pcc_18() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 18;
	}

	action rshift_pcc_19() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 19;
	}

	action rshift_pcc_20() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 20;
	}

	action rshift_pcc_21() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 21;
	}

	action rshift_pcc_22() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 22;
	}

	action rshift_pcc_23() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 23;
	}

	action rshift_pcc_24() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 24;
	}

	action rshift_pcc_25() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 25;
	}

	action rshift_pcc_26() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 26;
	}

	action rshift_pcc_27() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 27;
	}

	action rshift_pcc_28() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 28;
	}

	action rshift_pcc_29() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 29;
	}

	action rshift_pcc_30() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 30;
	}

	action rshift_pcc_31() {
		hdr.foo.ip_pcc = hdr.foo.ip_cov >> 31;
	}
