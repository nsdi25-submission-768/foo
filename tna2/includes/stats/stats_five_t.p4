control c_stats_five_t(inout header_t hdr, inout ingress_metadata_t ig_md) {
	...
	Register<bit<32>, _>(1) reg_five_t_mean_sqr_0;		// Squared mean for flow id (a->b)
	Register<bit<32>, _>(1) reg_five_t_mean_sqr_1;		// Squared mean for flow id (b->a)
	Register<bit<32>, _>(1) reg_five_t_variance_sqr_0;	// Squared variance for flow id (a->b)
	Register<bit<32>, _>(1) reg_five_t_variance_sqr_1;	// Squared variance for flow id (b->a)
	...
	RegisterAction<_, _, bit<32>>(reg_five_t_mean_sqr_0) ract_mean_sqr_0_calc = {
		void apply(inout bit<32> value, out bit<32> result) {
			value = square_mean_0.execute(ig_md.stats_five_t.mean_0);
			result = value;
		}
	};

	MathUnit<bit<32>>(MathOp_t.SQR, 1) square_mean_1;
	RegisterAction<_, _, bit<32>>(reg_five_t_mean_sqr_1) ract_mean_sqr_1_calc = {
		void apply(inout bit<32> value, out bit<32> result) {
			value = square_mean_1.execute(ig_md.stats_five_t.mean_1);
			result = value;
		}
	};
	...
	RegisterAction<_, _, bit<32>>(reg_five_t_variance_sqr_0) ract_variance_sqr_0_calc = {
		void apply(inout bit<32> value, out bit<32> result) {
	...
	RegisterAction<_, _, bit<32>>(reg_five_t_variance_sqr_1) ract_variance_sqr_1_calc = {
		void apply(inout bit<32> value, out bit<32> result) {
	...
	RegisterAction<_, _, bit<32>>(reg_five_t_magnitude) ract_magnitude_calc = {
		void apply(inout bit<32> value, out bit<32> result) {
			value = sqrt_magnitude.execute(ig_md.stats_five_t.mean_sqr_0);
			result = value;
		}
	};
	...
	RegisterAction<_, _, bit<32>>(reg_five_t_radius) ract_radius_calc = {
		void apply(inout bit<32> value, out bit<32> result) {
			value = sqrt_radius.execute(ig_md.stats_five_t.variance_sqr_0);
			result = value;
		}
	};
	...
	action mean_sqr_0_calc() {
		ig_md.stats_five_t.mean_sqr_0 = ract_mean_sqr_0_calc.execute(0);
	}

	action mean_sqr_1_calc() {
		ig_md.stats_five_t.mean_sqr_1 = ract_mean_sqr_1_calc.execute(0);
	}
	...
	action rshift_mean_ss_0_0() {
		ig_md.stats_five_t.mean_ss_0 = ig_md.stats_five_t.ss_0;
	}

	action rshift_mean_ss_0_1() {
		ig_md.stats_five_t.mean_ss_0 = ig_md.stats_five_t.ss_0 >> 1;
	}

	action rshift_mean_ss_0_2() {
		ig_md.stats_five_t.mean_ss_0 = ig_md.stats_five_t.ss_0 >> 2;
	}

	action rshift_mean_ss_0_3() {
		ig_md.stats_five_t.mean_ss_0 = ig_md.stats_five_t.ss_0 >> 3;
	}

	action rshift_mean_ss_0_4() {
		ig_md.stats_five_t.mean_ss_0 = ig_md.stats_five_t.ss_0 >> 4;
	}

	action rshift_mean_ss_0_5() {
		ig_md.stats_five_t.mean_ss_0 = ig_md.stats_five_t.ss_0 >> 5;
	}

	action rshift_mean_ss_0_6() {
		ig_md.stats_five_t.mean_ss_0 = ig_md.stats_five_t.ss_0 >> 6;
	}

	action rshift_mean_ss_0_7() {
		ig_md.stats_five_t.mean_ss_0 = ig_md.stats_five_t.ss_0 >> 7;
	}

	action rshift_mean_ss_0_8() {
		ig_md.stats_five_t.mean_ss_0 = ig_md.stats_five_t.ss_0 >> 8;
	}

	action rshift_mean_ss_0_9() {
		ig_md.stats_five_t.mean_ss_0 = ig_md.stats_five_t.ss_0 >> 9;
	}

	action rshift_mean_ss_0_10() {
		ig_md.stats_five_t.mean_ss_0 = ig_md.stats_five_t.ss_0 >> 10;
	}

	action rshift_mean_ss_0_11() {
		ig_md.stats_five_t.mean_ss_0 = ig_md.stats_five_t.ss_0 >> 11;
	}

	action rshift_mean_ss_0_12() {
		ig_md.stats_five_t.mean_ss_0 = ig_md.stats_five_t.ss_0 >> 12;
	}

	action rshift_mean_ss_0_13() {
		ig_md.stats_five_t.mean_ss_0 = ig_md.stats_five_t.ss_0 >> 13;
	}

	action rshift_mean_ss_0_14() {
		ig_md.stats_five_t.mean_ss_0 = ig_md.stats_five_t.ss_0 >> 14;
	}

	action rshift_mean_ss_0_15() {
		ig_md.stats_five_t.mean_ss_0 = ig_md.stats_five_t.ss_0 >> 15;
	}

	action rshift_mean_ss_0_16() {
		ig_md.stats_five_t.mean_ss_0 = ig_md.stats_five_t.ss_0 >> 16;
	}

	action rshift_mean_ss_0_17() {
		ig_md.stats_five_t.mean_ss_0 = ig_md.stats_five_t.ss_0 >> 17;
	}

	action rshift_mean_ss_0_18() {
		ig_md.stats_five_t.mean_ss_0 = ig_md.stats_five_t.ss_0 >> 18;
	}

	action rshift_mean_ss_0_19() {
		ig_md.stats_five_t.mean_ss_0 = ig_md.stats_five_t.ss_0 >> 19;
	}

	action rshift_mean_ss_0_20() {
		ig_md.stats_five_t.mean_ss_0 = ig_md.stats_five_t.ss_0 >> 20;
	}

	action rshift_mean_ss_1_0() {
		ig_md.stats_five_t.mean_ss_1 = ig_md.stats_five_t.ss_1;
	}

	action rshift_mean_ss_1_1() {
		ig_md.stats_five_t.mean_ss_1 = ig_md.stats_five_t.ss_1 >> 1;
	}

	action rshift_mean_ss_1_2() {
		ig_md.stats_five_t.mean_ss_1 = ig_md.stats_five_t.ss_1 >> 2;
	}

	action rshift_mean_ss_1_3() {
		ig_md.stats_five_t.mean_ss_1 = ig_md.stats_five_t.ss_1 >> 3;
	}

	action rshift_mean_ss_1_4() {
		ig_md.stats_five_t.mean_ss_1 = ig_md.stats_five_t.ss_1 >> 4;
	}

	action rshift_mean_ss_1_5() {
		ig_md.stats_five_t.mean_ss_1 = ig_md.stats_five_t.ss_1 >> 5;
	}

	action rshift_mean_ss_1_6() {
		ig_md.stats_five_t.mean_ss_1 = ig_md.stats_five_t.ss_1 >> 6;
	}

	action rshift_mean_ss_1_7() {
		ig_md.stats_five_t.mean_ss_1 = ig_md.stats_five_t.ss_1 >> 7;
	}

	action rshift_mean_ss_1_8() {
		ig_md.stats_five_t.mean_ss_1 = ig_md.stats_five_t.ss_1 >> 8;
	}

	action rshift_mean_ss_1_9() {
		ig_md.stats_five_t.mean_ss_1 = ig_md.stats_five_t.ss_1 >> 9;
	}

	action rshift_mean_ss_1_10() {
		ig_md.stats_five_t.mean_ss_1 = ig_md.stats_five_t.ss_1 >> 10;
	}

	action rshift_mean_ss_1_11() {
		ig_md.stats_five_t.mean_ss_1 = ig_md.stats_five_t.ss_1 >> 11;
	}

	action rshift_mean_ss_1_12() {
		ig_md.stats_five_t.mean_ss_1 = ig_md.stats_five_t.ss_1 >> 12;
	}

	action rshift_mean_ss_1_13() {
		ig_md.stats_five_t.mean_ss_1 = ig_md.stats_five_t.ss_1 >> 13;
	}

	action rshift_mean_ss_1_14() {
		ig_md.stats_five_t.mean_ss_1 = ig_md.stats_five_t.ss_1 >> 14;
	}

	action rshift_mean_ss_1_15() {
		ig_md.stats_five_t.mean_ss_1 = ig_md.stats_five_t.ss_1 >> 15;
	}

	action rshift_mean_ss_1_16() {
		ig_md.stats_five_t.mean_ss_1 = ig_md.stats_five_t.ss_1 >> 16;
	}

	action rshift_mean_ss_1_17() {
		ig_md.stats_five_t.mean_ss_1 = ig_md.stats_five_t.ss_1 >> 17;
	}

	action rshift_mean_ss_1_18() {
		ig_md.stats_five_t.mean_ss_1 = ig_md.stats_five_t.ss_1 >> 18;
	}

	action rshift_mean_ss_1_19() {
		ig_md.stats_five_t.mean_ss_1 = ig_md.stats_five_t.ss_1 >> 19;
	}

	action rshift_mean_ss_1_20() {
		ig_md.stats_five_t.mean_ss_1 = ig_md.stats_five_t.ss_1 >> 20;
	}
	...
	action variance_sqr_0_calc() {
		ig_md.stats_five_t.variance_sqr_0 = ract_variance_sqr_0_calc.execute(0);
	}

	action variance_sqr_1_calc() {
		ig_md.stats_five_t.variance_sqr_1 = ract_variance_sqr_1_calc.execute(0);
	}
	...
	action rshift_cov_0() {
		hdr.foo.five_t_cov = ig_md.stats_five_t.sum_res_prod;
	}

	action rshift_cov_1() {
		hdr.foo.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 1;
	}

	action rshift_cov_2() {
		hdr.foo.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 2;
	}

	action rshift_cov_3() {
		hdr.foo.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 3;
	}

	action rshift_cov_4() {
		hdr.foo.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 4;
	}

	action rshift_cov_5() {
		hdr.foo.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 5;
	}

	action rshift_cov_6() {
		hdr.foo.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 6;
	}

	action rshift_cov_7() {
		hdr.foo.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 7;
	}

	action rshift_cov_8() {
		hdr.foo.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 8;
	}

	action rshift_cov_9() {
		hdr.foo.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 9;
	}

	action rshift_cov_10() {
		hdr.foo.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 10;
	}

	action rshift_cov_11() {
		hdr.foo.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 11;
	}

	action rshift_cov_12() {
		hdr.foo.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 12;
	}

	action rshift_cov_13() {
		hdr.foo.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 13;
	}

	action rshift_cov_14() {
		hdr.foo.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 14;
	}

	action rshift_cov_15() {
		hdr.foo.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 15;
	}

	action rshift_cov_16() {
		hdr.foo.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 16;
	}

	action rshift_cov_17() {
		hdr.foo.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 17;
	}

	action rshift_cov_18() {
		hdr.foo.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 18;
	}

	action rshift_cov_19() {
		hdr.foo.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 19;
	}

	action rshift_cov_20() {
		hdr.foo.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 20;
	}

	action lshift_std_dev_prod_0() {
		ig_md.stats_five_t.std_dev_prod = ig_md.stats_five_t.std_dev_0;
	}
	...
	action rshift_pcc_0() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov;
	}

	action rshift_pcc_1() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 1;
	}

	action rshift_pcc_2() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 2;
	}

	action rshift_pcc_3() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 3;
	}

	action rshift_pcc_4() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 4;
	}

	action rshift_pcc_5() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 5;
	}

	action rshift_pcc_6() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 6;
	}

	action rshift_pcc_7() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 7;
	}

	action rshift_pcc_8() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 8;
	}

	action rshift_pcc_9() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 9;
	}

	action rshift_pcc_10() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 10;
	}

	action rshift_pcc_11() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 11;
	}

	action rshift_pcc_12() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 12;
	}

	action rshift_pcc_13() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 13;
	}

	action rshift_pcc_14() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 14;
	}

	action rshift_pcc_15() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 15;
	}

	action rshift_pcc_16() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 16;
	}

	action rshift_pcc_17() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 17;
	}

	action rshift_pcc_18() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 18;
	}

	action rshift_pcc_19() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 19;
	}

	action rshift_pcc_20() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 20;
	}

	action rshift_pcc_21() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 21;
	}

	action rshift_pcc_22() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 22;
	}

	action rshift_pcc_23() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 23;
	}

	action rshift_pcc_24() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 24;
	}

	action rshift_pcc_25() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 25;
	}

	action rshift_pcc_26() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 26;
	}

	action rshift_pcc_27() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 27;
	}

	action rshift_pcc_28() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 28;
	}

	action rshift_pcc_29() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 29;
	}

	action rshift_pcc_30() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 30;
	}

	action rshift_pcc_31() {
		hdr.foo.five_t_pcc = hdr.foo.five_t_cov >> 31;
	}
	...
	table mean_ss_1 {
		key = {
			ig_md.stats_five_t.pkt_cnt_1: ternary;
		}
		actions = {
			rshift_mean_ss_1_0;
			rshift_mean_ss_1_1;
	...
	apply {
		...
		ig_md.stats_five_t.mean_sqr_0 = ig_md.stats_five_t.mean_sqr_0 + ig_md.stats_five_t.mean_sqr_1;
		magnitude_calc();

		// Variance calculation.

		ig_md.stats_five_t.variance_0 = ig_md.stats_five_t.mean_sqr_0 - ig_md.stats_five_t.mean_ss_0;
		ig_md.stats_five_t.variance_0_neg = ig_md.stats_five_t.mean_ss_0 - ig_md.stats_five_t.mean_sqr_0;
		variance_0_abs.apply();

		ig_md.stats_five_t.variance_1 = ig_md.stats_five_t.mean_sqr_1 - ig_md.stats_five_t.mean_ss_1;
		ig_md.stats_five_t.variance_1_neg = ig_md.stats_five_t.mean_ss_1 - ig_md.stats_five_t.mean_sqr_1;
		...
		ig_md.stats_five_t.variance_sqr_0 = ig_md.stats_five_t.variance_sqr_0 + ig_md.stats_five_t.variance_sqr_1;
		radius_calc();

		// Approx. Covariance calculation.

		// Weight 1 + Weight 2.
		ig_md.stats_five_t.pkt_cnt_1 = ig_md.stats_five_t.pkt_cnt_1 + ig_md.stats_five_t.pkt_cnt_0;
