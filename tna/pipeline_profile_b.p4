...
control SwitchIngress_b(
    ...
    action set_foo_ip_b_64() {
        hdr.foo.ip_sum_res_prod_cov = ig_md.stats_ip.cov;
        hdr.foo.ip_pcc = ig_md.stats_ip.pcc;
    }

    action set_foo_five_t_b() {
        hdr.foo.five_t_magnitude = ig_md.stats_five_t.magnitude;
        hdr.foo.five_t_radius = ig_md.stats_five_t.radius;
    }

    action set_foo_five_t_b_64() {
        hdr.foo.five_t_sum_res_prod_cov = ig_md.stats_five_t.cov;
